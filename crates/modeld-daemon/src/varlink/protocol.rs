//! Varlink wire protocol framing and serialization.
//!
//! Enforces standard NUL-byte (0x00) delimited JSON message framing.
...
pub struct VarlinkCall {
    /// Fully qualified interface method name (e.g. "io.syntrop.Model1.List").
    pub method: String,
...
pub struct VarlinkReply {
    ...
    pub parameters: Option<Value>,
    /// Error identifier on failure (e.g. "io.syntrop.Model1.NoSuchModel").
    #[serde(skip_serializing_if = "Option::is_none")]
